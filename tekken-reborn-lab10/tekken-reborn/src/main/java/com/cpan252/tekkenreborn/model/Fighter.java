...
// name to the table
/**
 * @Entity is a JPA annotation to make this object ready for storage in a JPA
 *         based data store. (required)
 * @Id is a JPA annotation to make this field the primary key for this object.
 *     (required)
 * @GeneratedValue is a JPA annotation to make this field auto-generated by the
 *                 JPA provider (required).
 *                 We also have to have no argument constructor for object to be
 *                 created by JPA.
 */
@Entity
